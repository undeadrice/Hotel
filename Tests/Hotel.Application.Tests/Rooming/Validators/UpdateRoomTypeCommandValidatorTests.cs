...
public class UpdateRoomTypeCommandValidatorTests
{
    private readonly UpdateRoomTypeCommandValidator _validator = new();

    private static UpdateRoomTypeCommand CreateValidCommand() =>
        new(Guid.NewGuid(), "Standard", null);
